...
const Pathing = __webpack_require__(3);
...
var Pathing = __webpack_require__(3);
...
const creepsConfig = __webpack_require__(4);
...
const workerCtors = {
    attack: __webpack_require__(27),
    build: __webpack_require__(28),
    defend: __webpack_require__(29),
    deliver: __webpack_require__(30),
    dismantle: __webpack_require__(31),
    downgrade: __webpack_require__(32),
    heal: __webpack_require__(33),
    idle: __webpack_require__(34),
    keep: __webpack_require__(35),
    mine: __webpack_require__(36),
    observe: __webpack_require__(37),
    pickup: __webpack_require__(38),
    repair: __webpack_require__(39),
    reserve: __webpack_require__(40),
    squad: __webpack_require__(41),
    transfer: __webpack_require__(44),
    upgrade: __webpack_require__(45)
};
...
class Worker {
    ...
    static process(cluster){
        ...
        _.forEach(creeps, Worker.work.bind(this, cluster));
...
const Combat = __webpack_require__(42);
const Movement = __webpack_require__(43);
...
var Poly = __webpack_require__(10);
var Startup = __webpack_require__(11);
var Traveller = __webpack_require__(12);

var Federation = __webpack_require__(13);
var AutoBuilder = __webpack_require__(46);
var Cluster = __webpack_require__(5);
var Controller = __webpack_require__(47);
var Spawner = __webpack_require__(6);
var Worker = __webpack_require__(7);
var Production = __webpack_require__(48);
var Pathing = __webpack_require__(3);
var Squad = __webpack_require__(8);
...
const Cluster = __webpack_require__(5);
const creeps = __webpack_require__(4);
...
const DefenseMatrix = __webpack_require__(14);
const ProcessSystem = __webpack_require__(15);
...
class ProcessSystem {
    ...
    enqueueCreep(priority, cluster, creep) {
        this.queue.push({ priority, creep, cluster });
    }
    queueProcess(priority, cluster, process) {
        this.queue.push({ priority, process, cluster });
    }
    process() {
        const sortedQueue = _.sortBy(this.queue, 'priority');
        for (let entry of sortedQueue) {
            if (entry.creep) {
                Worker.process(Game.clusters[entry.cluster], entry.creep);
            }
            else if (entry.process) {
                //TODO process step here
            }
        }
    }
}
/* harmony export (immutable) */ __webpack_exports__["default"] = ProcessSystem;
...
var Avoid = __webpack_require__(17);
var Boost = __webpack_require__(18);
var Convert = __webpack_require__(19);
var Defend = __webpack_require__(20);
var Energy = __webpack_require__(21);
var MinecartAction = __webpack_require__(22);
var Rampart = __webpack_require__(23);
var Recycle = __webpack_require__(24);
var Repair = __webpack_require__(25);
var SelfHeal = __webpack_require__(26);
...
var BaseAction = __webpack_require__(2);
...
const BaseAction = __webpack_require__(2);
const Util = __webpack_require__(1);
const creepsConfig = __webpack_require__(4);
...
const BaseWorker = __webpack_require__(0);
...
class ReserveWorker extends BaseWorker {
    ...
    reserve(cluster, subtype){
        var controllers = _.map(_.filter(cluster.roomflags.reserve, room => _.get(room, 'controller.reservation.ticksToEnd', 0) < 3000 && room.controller && !room.controller.owner), 'controller');
...
const BaseWorker = __webpack_require__(0);
const Squad = __webpack_require__(8);
